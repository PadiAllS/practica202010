...
<b-container fluid id="app" class="bg-info bv-example-row  text-center text-light">
    ...
    <div class="form-group">
        ...
        <select class="form-control" v-on:change='getHorarioxMedico()' v-model="medicohorario.medico_id">
    ...
    <div class="form-group" v-if= "horarioxMedico.length === 1">
        <span>Especialidad: {{ medicos[0].especialidad.nombre }}</span>
    </div>

    <div>
        <button @click="showModal=true" type='button' class="btn btn-primary mb-3">Nuevo Horario</button>
    </div>
                ...
                <b-table-simple stacked='md' class="table bordered" bordered :head-variant="headVariant" :table-variant="tableVariant">
                    ...
                    <template>
                        <b-tbody table-variant="warning">
                            <b-tr v-if="medicos.length === 1" v-for="hora in medicos[0].horarioatencions" v-bind:key="hora.id_horarioAtencion">
            ...
            getHorarioxMedico: function (medicos){
                ...
                for (var i = 0; i < medicos.length; i++){ 
                    if ( medicos[i].id_medico === this.medicohorario.medico_id) {
                        this.horarioxMedico.push(medicos[i]);
                    }
                    return this.horarioxMedico;
                }
            },
